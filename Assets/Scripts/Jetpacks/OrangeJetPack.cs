...
public class OrangeJetPack : JetPack {
    ...
    public OrangeJetPack()
    {
        ...
        step = OrangeJetPack.STEP;
        sideStep = OrangeJetPack.SIDE_STEP;
        fuel = OrangeJetPack.MAX_FUEL;
        fuelToAdd = OrangeJetPack.FUEL_ADD_FLIGHT;
        fuelToMinus = OrangeJetPack.FUEL_MINUS;
        fuelToAddInFlight = OrangeJetPack.FUEL_ADD_FLIGHT;
        fuelToAddOnBridge = OrangeJetPack.FUEL_ADD_BRIDGE;
        maxFuel = OrangeJetPack.MAX_FUEL;
    }
