...
public class RareJetPack : JetPack
{
    ...
    public RareJetPack()
    {
        ...
        step = RareJetPack.STEP;
        power = RareJetPack.POWER;
        fuel = RareJetPack.MAX_FUEL;
        fuelToAdd = RareJetPack.FUEL_ADD_FLIGHT;
        fuelToMinus = RareJetPack.FUEL_MINUS;
        fuelToAddInFlight = RareJetPack.FUEL_ADD_FLIGHT;
        maxFuel = RareJetPack.MAX_FUEL;

        numScrews = RareJetPack.NUM_SCREWS;
        numMetal = RareJetPack.NUM_Metal;
        specialPart = RareJetPack.SPECIAL_PART;
    }
