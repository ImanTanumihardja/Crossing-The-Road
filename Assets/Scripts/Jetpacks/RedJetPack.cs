...
public class RedJetPack : JetPack
{
    ...
    public RedJetPack()
    {
        ...
        step                = RedJetPack.STEP;
        sideStep            = RedJetPack.SIDE_STEP;
        fuel                = RedJetPack.MAX_FUEL;
        fuelToAdd           = RedJetPack.FUEL_ADD_FLIGHT;
        fuelToMinus         = RedJetPack.FUEL_MINUS;
        fuelToAddInFlight   = RedJetPack.FUEL_ADD_FLIGHT;
        fuelToAddOnBridge   = RedJetPack.FUEL_ADD_BRIDGE;
        maxFuel             = RedJetPack.MAX_FUEL;
    }
