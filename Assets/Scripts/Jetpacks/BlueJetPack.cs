...
public class BlueJetPack : JetPack
{
    private const float STEP = 20f;  // how far the chicken moves
    private const float SIDE_STEP = 30f;  // How far the chicken moves sideways
    ...
    public BlueJetPack()
    {
        ...
        step              = BlueJetPack.STEP;
        sideStep          = BlueJetPack.SIDE_STEP;
        fuel              = BlueJetPack.MAX_FUEL;
        fuelToAdd         = BlueJetPack.FUEL_ADD_FLIGHT;
        fuelToMinus       = BlueJetPack.FUEL_MINUS;
        fuelToAddInFlight = BlueJetPack.FUEL_ADD_FLIGHT;
        fuelToAddOnBridge = BlueJetPack.FUEL_ADD_BRIDGE;
        maxFuel           = BlueJetPack.MAX_FUEL;
    }
